      ...
      <div className="flex-1 flex items-center justify-center py-8 px-6">
        <div className="w-full max-w-lg">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-sm">Join European businesses using EcoKeepr to recover payments</p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Must contain uppercase, lowercase, and number (8+ chars)
                </p>
                {errors.password && (
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-2.5 px-4 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
          ...
          <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div className="text-center mb-2">
              <h3 className="text-sm font-medium text-gray-900">Trusted by European Businesses</h3>
            </div>
            <div className="grid grid-cols-3 gap-4 text-center text-xs">
              ...
              <div>
                <div className="font-bold text-purple-600">GDPR</div>
      ...
      <footer className="border-t border-gray-200 bg-gray-50 py-4">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-2 text-sm">
            <p className="text-gray-600">&copy; 2024 EcoKeepr. All rights reserved.</p>
